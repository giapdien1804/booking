...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_perfect_scrollbar__ = __webpack_require__(172);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getDomainList: function getDomainList(name, page) {
            ...
            axios.get('/customer/domain/list', { params: { name: name, page: page } }).then(function (res) {
        ...
        selectItem: function selectItem(value) {
            if (this.gotoUrl !== '') {
                var url = this.gotoUrl.replace('{id}', value.id);
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.itemSelected.id,
            expression: "itemSelected.id"
          }
        ],
        attrs: { type: "hidden", name: _vm.dataName },
        domProps: { value: _vm.itemSelected.id },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.itemSelected, "id", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
              ...
              _vm._l(_vm.itemData, function(item) {
                return _c(
                  "a",
                  {
                    class: {
                      "dropdown-item": true,
                      "is-active": _vm.itemSelected.id === item.id
                    },
                    on: {
