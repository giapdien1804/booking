...
var _tabs = __webpack_require__(326);

var _perfectScrollbar = __webpack_require__(173);

var _perfectScrollbar2 = _interopRequireDefault(_perfectScrollbar);

var _LazyImg = __webpack_require__(147);
...
exports.default = {
                ...
                if (!parent) {
                    ...
                    var FilePicker = Vue.extend({
                        ...
                        render: function render(h) {
                            return h('div', {
                                'class': (0, _defineProperty3.default)({}, "" + className, true)
                            });
                        }
                    });
    ...
    mounted: function mounted() {
        ...
        new _perfectScrollbar2.default(panel_album_show, {
        ...
        new _perfectScrollbar2.default(upload_content, {
            minScrollbarLength: 50,
            suppressScrollX: true
        });

        new _perfectScrollbar2.default(globalFmg, {
            minScrollbarLength: 50,
            suppressScrollX: true
        });
    ...
    computed: {
        detailData: function detailData() {
            ...
            return _.filter(this.expData.data, function (o) {
                return _this2.selectItem.indexOf(o.uuid) > -1;
            });
        }
    },
    watch: {
    ...
    methods: {
        ...
        panelAlbumList: function panelAlbumList() {
            ...
            window.axios.get('/storage/album/d/' + this.domain).then(function (res) {
                ...
                if ((0, _keys2.default)(_this7.panelAlbum.current).length <= 0) _this7.panelAlbum.current = _.nth(_this7.panelAlbum.list, 0);
            });
        },
                ...
                onConfirm: function onConfirm(msg) {
                    window.axios.delete('/storage/file/trash', { data: _this12.selectItem }).then(function () {
                        ...
                        _this12.expData.data = _.filter(_this12.expData.data, function (o) {
                            return _this12.selectItem.indexOf(o.uuid) === -1;
                        });
                        //remove select item
                        _this12.selectItem = [];
                        msg.close();
        ...
        panelDetailSave: function panelDetailSave() {
            ...
            var data = _.filter(this.expData.data, function (o) {
                return _this14.selectItem.indexOf(o.uuid) > -1;
            });
        ...
        panelDetailRestoreTrash: function panelDetailRestoreTrash() {
            ...
            window.axios.post('/storage/file/restore', this.selectItem).then(function () {
                //update expl data
                _this16.expData.data = _.filter(_this16.expData.data, function (o) {
                    return _this16.selectItem.indexOf(o.uuid) === -1;
                });
                //remove select item
                _this16.selectItem = [];
            });
        ...
        clickPickFile: function clickPickFile() {
            ...
            var data = _.filter(this.expData.data, function (o) {
                return _this19.selectItem.indexOf(o.uuid) > -1;
            });
...
var _TabList = __webpack_require__(229);

var _TabList2 = _interopRequireDefault(_TabList);

var _TabPane = __webpack_require__(334);
...
exports.default = {
    ...
    methods: {
        update: function update() {
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)(this.tabPanes), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                                ...
                                ? _c("div", { staticClass: "field" }, [
                                    _c("p", { staticClass: "has-text-small" }, [
                                      ...
                                      _c("span", {
                                        domProps: {
                                          textContent: _vm._s(
                                            _vm.humanFileSize(item.storage_size)
                                          )
                                        }
                                      }),
                                      _c("br")
