...
namespace App\Helpers\Facades { 
    ...
    class DG {
        ...
        {
            return \App\Helpers\Diengiap::standardName($str, $space, $lower);
        }
         ...
         * @static 
         */ 
        public static function valueToIcon($value, $true, $icon, $tooltip = '')
        {
            return \App\Helpers\Diengiap::valueToIcon($value, $true, $icon, $tooltip);
        }
        ...
        {
            return \App\Helpers\Diengiap::setKey($value);
        }
        ...
        {
            return \App\Helpers\Diengiap::getKey($value);
        }
        ...
        {
            return \App\Helpers\Diengiap::human_fileSize($bytes, $decimals);
        }
         ...
         * @static 
         */ 
        public static function getFontIconArray($path, $class_prefix = 'fa-')
        {
            return \App\Helpers\Diengiap::getFontIconArray($path, $class_prefix);
        }
        ...
        {
            return \App\Helpers\Diengiap::createImageThumbnail($disk, $path, $width, $height, $type, $option);
        }
        ...
        {
            return \App\Helpers\Diengiap::extraByKey($key, $extras);
        }
    ...
    class Bulma {
         ...
         * @static 
         */ 
        public static function addOnBtn($class = '', $target = '', $title = '', $icon = '', $label = '')
        {
            return \App\Helpers\Bulma::addOnBtn($class, $target, $title, $icon, $label);
        }
         ...
         * @static 
         */ 
        public static function text($label, $name, $value = null, $help = '', $icon = '', $before = '', $after = '', $add_on = array())
        {
            return \App\Helpers\Bulma::text($label, $name, $value, $help, $icon, $before, $after, $add_on);
        }
         ...
         * @static 
         */ 
        public static function textarea($label, $name, $value = null, $before = '', $after = '')
        {
            return \App\Helpers\Bulma::textarea($label, $name, $value, $before, $after);
        }
         ...
         * @static 
         */ 
        public static function email($label, $name, $value = null, $before = '', $after = '')
        {
            return \App\Helpers\Bulma::email($label, $name, $value, $before, $after);
        }
         ...
         * @static 
         */ 
        public static function password($label, $name, $value = null, $before = '', $after = '')
        {
            return \App\Helpers\Bulma::password($label, $name, $value, $before, $after);
        }
         ...
         * @static 
         */ 
        public static function checkBox($label, $name, $value = null, $checked = false, $before = '', $after = '')
        {
            return \App\Helpers\Bulma::checkBox($label, $name, $value, $checked, $before, $after);
        }
         ...
         * @static 
         */ 
        public static function checkBoxList($name, $data = array(), $checked = array(), $before = '', $after = '')
        {
            return \App\Helpers\Bulma::checkBoxList($name, $data, $checked, $before, $after);
        }
         ...
         * @static 
         */ 
        public static function select($label, $name, $data = array(), $selected = null, $null_value = false, $icon = '', $before = '', $after = '', $add_on = array())
        {
            return \App\Helpers\Bulma::select($label, $name, $data, $selected, $null_value, $icon, $before, $after, $add_on);
        }
        ...
        {
            return \App\Helpers\Bulma::breadcrumb($data);
        }
         ...
         * @static 
         */ 
        public static function shortLink($route, $name, $type)
        {
            return \App\Helpers\Bulma::shortLink($route, $name, $type);
        }
...
namespace  { 
    ...
    class DG extends \App\Helpers\Facades\DG {}

    class Bulma extends \App\Helpers\Facades\Bulma {}
